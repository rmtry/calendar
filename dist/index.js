...
// API key: AIzaSyC4RCXbYRUYKXThJBjqyJ9ezyhkyPA9UQ8
const app = (0, express_1.default)();
const port = 3000;
const oauth2Client = new OAuth2Client("633927587528-p5mfqon3fo0ceu5s3cp07snd0k6hkq4j.apps.googleusercontent.com", "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", "http://localhost:3000/oauth2callback");
...
app.post("/verify-code", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const ticket = yield oauth2Client.verifyIdToken({
        ...
        audience: "633927587528-p5mfqon3fo0ceu5s3cp07snd0k6hkq4j.apps.googleusercontent.com",
    });
